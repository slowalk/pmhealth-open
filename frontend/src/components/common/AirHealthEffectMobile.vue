    ...
    svg(:ref="targetId" :id="targetId")
      g(v-if="targetLocation")
        g.step-1
          ...
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 1 ? 'bold' : 'normal'") 1
        g.step-2
          rect(fill="rgb(0,143,195)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 2 ? 'bold' : 'normal'") 2
        g.step-3
          rect(fill="rgb(0,90,142)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 3 ? 'bold' : 'normal'") 3
        g.step-4
          rect(fill="rgb(252,255,8)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 4 ? 'bold' : 'normal'") 4
        g.step-5
          rect(fill="rgb(255,197,6)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 5 ? 'bold' : 'normal'") 5
        g.step-6
          rect(fill="rgb(255,144,47)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 6 ? 'bold' : 'normal'") 6
        g.step-7
          rect(fill="rgb(255,91,93)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 7 ? 'bold' : 'normal'") 7
        g.step-8
          rect(fill="rgb(253,0,7)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 8 ? 'bold' : 'normal'") 8
        g.step-9
          rect(fill="rgb(197,0,8)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 9 ? 'bold' : 'normal'") 9
        g.step-10
          rect(fill="rgb(143,0,2)" height="17px" width="9%")
          text(text-anchor="middle" x="4.5%" y="13" fill="white" :font-weight="onDot && Math.ceil(targetLocation.Index_total_PM10) == 10 ? 'bold' : 'normal'") 10
        g.step-11
      ...
      g.legend-range(v-if="onLegendRange")
        //- 낮음
        g.low
...
<script>
  export default {
    props: ["targetLocation", "targetId", "onDot", "onLegendRange"],
    methods: {
        ...
        this.$nextTick(()=>{
          ...
          if(this.onDot) {
            ...
            const legendDot = d3.select(`#${this.targetId} .legend-dot`)
              .attr("transform", `translate(${(value <= 10 ? Math.floor(value) + 0.5 : 10.5) / 11 * airHealthEffectDotWidth },3)`)
              // .attr("transform", `translate(${(value <= 10 ? value : 10.5) / 11 * airHealthEffectDotWidth },3)`)
