      ...
      .row
        ...
        .col-md-8.without_side_pd
          .h4.text-center
            b 초과사망자수
          //- p
            small 초과사망자수 600분위당 1입니다.
            // | 초과사망자수 600분위당 사람 아이콘 (&nbsp;
            // img(src="../../../../assets/person.png" style="height: 20px;")
            // | &nbsp;) 1개 입니다.
        ...
        .col-md-2
      .text-center
        //- router-link(to="/survey/model3/question/prime" class="btn btn-primary") 다음으로
...
export default {
  ...
  methods: {
    ...
    onSggDeHovered() {
      document.getElementById("PM2_5_" + this.currentSgg.SD_CD).classList.toggle("hover");
      // console.log("this.currentSgg : ", this.currentSgg)
