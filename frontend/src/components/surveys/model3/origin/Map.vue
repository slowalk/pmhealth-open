...
import cigar from "../../../../assets/cigar1.png"
...
export default {
  ...
  methods: {
    ...
    magnifyMap(width, height, path, d, g1, ac, control) {
      // console.log('d3.select(".cigarWrapper") : ', d3.select(".cigarWrapper"))
  ...
  mounted() {
    ...
    label_g.selectAll("rect")
      ...
      .attr("y", function(d) { 
        ...
        if("경상북도" == d.properties.SIDO_NM) return path.centroid(d)[1] - 30
    ...
    label_g.selectAll("text.SD_NM")
      ...
      .attr("y", function(d) { 
        ...
        if("경상북도" == d.properties.SIDO_NM) return path.centroid(d)[1] + fontSize/2 + label_padding_height - 30
    ...
    //     if("인천광역시" == d.properties.SIDO_NM) return path.centroid(d)[0] + label_padding_width - 30
    //     // if("광주광역시" == d.properties.SIDO_NM) return path.bounds(d)[0][0] - 100 + label_padding_width
    //     if("충청남도" == d.properties.SIDO_NM) return path.bounds(d)[0][0] + label_padding_width + 70
    //     // if("전라북도" == d.properties.SIDO_NM) return path.bounds(d)[0][0] - 90 + label_padding_width
    //     // if("충청북도" == d.properties.SIDO_NM) return path.bounds(d)[0][0] + 140 + label_padding_width
    //     // if("경상남도" == d.properties.SIDO_NM) return path.bounds(d)[1][0] - 70 + label_padding_width
    ...
    //     // if("제주특별자치도" == d.properties.SIDO_NM) return path.bounds(d)[1][0] + 20 + label_padding_width
    //     // if(["강원도", "경상북도", "부산광역시"].includes(d.properties.SIDO_NM)) return path.bounds(d)[1][0]  + label_padding_width
    //     if(["강원도", "경상북도", "전라북도", "경상남도", "제주특별자치도", "충청북도"].includes(d.properties.SIDO_NM)) return path.centroid(d)[0]+ label_padding_width - 20
    //     // else return path.bounds(d)[0][0] + label_padding_width
    ...
    //     if("경기도" == d.properties.SIDO_NM) return path.centroid(d)[1] + 15 + fontSize + label_padding_height* 2
    //     // if("충청북도" == d.properties.SIDO_NM) return path.bounds(d)[0][1]  + fontSize + label_padding_height* 2
    //     if("세종특별자치시" == d.properties.SIDO_NM) return path.bounds(d)[0][1] + fontSize + label_padding_height* 2 - 20
    //     if("경상북도" == d.properties.SIDO_NM) return path.centroid(d)[1] + fontSize + label_padding_height*2 - 30
    ...
    //     if(["강원도", "전라북도", "경상남도", "제주특별자치도", "충청북도"].includes(d.properties.SIDO_NM)) return path.centroid(d)[1] + fontSize + label_padding_height*2 - 20
    ...
    label_g.selectAll("text.dataNum")
      ...
      .attr("y", function(d) { 
        // if("서울특별시" == d.properties.SIDO_NM) return path.bounds(d)[0][1] - 40 + fontSize*2 + label_padding_height*4
        // if("경기도" == d.properties.SIDO_NM) return path.centroid(d)[1] + 15 + fontSize*2 + label_padding_height*4
        // // if("충청북도" == d.properties.SIDO_NM) return path.bounds(d)[0][1] + fontSize*2 + label_padding_height*4
        // if("세종특별자치시" == d.properties.SIDO_NM) return path.bounds(d)[0][1] + fontSize*2 + label_padding_height*4 - 20
        // if("경상북도" == d.properties.SIDO_NM) return path.centroid(d)[1] + fontSize*2 + label_padding_height*4 - 30
        // if("대구광역시" == d.properties.SIDO_NM) return path.centroid(d)[1] - 30+ fontSize*2 + label_padding_height*4
        // if("울산광역시" == d.properties.SIDO_NM) return path.bounds(d)[0][1] + fontSize*2 + label_padding_height*4
        // // if(["부산광역시", "경상남도", "전라남도"].includes(d.properties.SIDO_NM)) return path.bounds(d)[1][1]  + fontSize/2 + label_padding_height
        // if(["강원도", "전라북도", "경상남도", "제주특별자치도", "충청북도"].includes(d.properties.SIDO_NM)) return path.centroid(d)[1] + fontSize*2 + label_padding_height*4 - 20
        // // if("제주특별자치도" == d.properties.SIDO_NM) return path.centroid(d)[1] - 30 + fontSize/2 + label_padding_height
        // // else return path.bounds(d)[0][1] + fontSize/2 + label_padding_height
        // return path.centroid(d)[1] + fontSize*2 + label_padding_height*4

        if("서울특별시" == d.properties.SIDO_NM) return path.bounds(d)[0][1] - 40 + fontSize + label_padding_height*5
        ...
        if("경상북도" == d.properties.SIDO_NM) return path.centroid(d)[1] - 30 + fontSize + label_padding_height*5
