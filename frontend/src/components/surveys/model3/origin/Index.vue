      ...
      .row
        ...
        .col-md-8.without_side_pd
          ...
          //- p.mapExplain 
            ...
            sup 3 
            | 분위당 담배 1개피(
            img(src="../../../../assets/cigar1.png" style="width: 30px;")
            |)에 해당하는 위험입니다.
        ...
        .col-md-2
      .text-center
        //- router-link(:to="'/survey/model3/question?sd=' + currentSd" class="btn btn-primary") 다음으로
...
export default {
  ...
  methods: {
    ...
    onSggDeHovered() {
      let pm2_5 = document.getElementById("PM2_5_" + this.currentSgg.SD_CD);
